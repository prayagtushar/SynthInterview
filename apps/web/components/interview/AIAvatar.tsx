...
export const AIAvatar: React.FC<AIAvatarProps> = ({
  ...
  return (
    <div className="px-4 py-4 border-b border-indigo-500/20 shrink-0 bg-slate-900/30">
      <div className="flex items-center gap-3">
        <div className="relative">
          <div
            className={`w-10 h-10 rounded-full bg-gradient-to-br from-indigo-500/30 to-purple-500/30 flex items-center justify-center border transition-all duration-300 ${
              isSpeaking
