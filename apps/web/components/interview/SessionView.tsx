        ...
        <header className="h-14 border-b border-[#333] flex items-center justify-between px-6 bg-[#0a0a0a]">
          ...
          <div className="flex items-center gap-3">
            <div className="flex items-center gap-2 mr-4">
              ...
              ></div>
              <span
                className={`text-[10px] font-bold tracking-widest uppercase ${isConnected ? "text-green-500" : "text-red-500"}`}
              >
              ...
              <div className="space-y-4 max-h-60 overflow-y-auto pr-1 custom-scrollbar">
                {feedback.length === 0 ? (
                  ...
                  [...feedback].reverse().map((msg, i) => (
                    <div
                      key={i}
                      className="bg-[#111] p-3 rounded border border-[#222] animate-in fade-in slide-in-from-right-2 duration-300"
                    >
              ...
              <div className="space-y-6">
                <div className="space-y-2">
                  ...
                  <div className="h-1 bg-[#222] rounded-full overflow-hidden">
                    <div
                      className={`h-full bg-white w-0 transition-all duration-1000 ${isConnected ? "w-[10%]" : ""}`}
                    ></div>
                  </div>
                </div>
