  ...
  return (
    <div className="relative isolate overflow-hidden">
      ...
      <div className="hero-overlay relative z-10 pt-48 pb-24 md:pt-64 md:pb-48">
        ...
        >
          <motion.div variants={fadeUpVariants} className="section-badge mb-8 gap-2.5">
            <Sparkles size={14} className="text-white/40 flex-shrink-0" />
            <span className="leading-none translate-y-[0.5px]">Next-Gen Assessment Engine</span>
          </motion.div>

          <motion.h1 variants={fadeUpVariants} className="hero-title text-gradient !text-4xl md:!text-7xl leading-[1.1] mb-12">
            Hire with <span className="font-serif-italic">absolute</span> <br /> technical confidence.
          </motion.h1>

          <motion.p variants={fadeUpVariants} className="mt-8 text-white/70 max-w-2xl text-lg md:text-xl leading-relaxed mx-auto mb-16 px-6 group-hover:text-white transition-colors">
            Surgical technical screenings powered by autonomous voice AI. Verify engineering depth in real-time, at scale.
          </motion.p>
          ...
          >
            ...
            >
              <Zap size={16} className="text-white/60 group-hover:text-amber-400 transition-colors" />
              Launch Console
            </Link>
          </motion.div>
            ...
            >
              ...
              <div className="flex items-center justify-between px-10 py-5 border-b border-white/5">
                ...
                <div className="px-5 py-2 rounded-full border border-emerald-500/20 bg-emerald-500/5 flex items-center gap-3">
                   ...
                   <span className="text-[9px] font-black uppercase tracking-widest text-emerald-500/80 italic">Secure Session Live</span>
                </div>
              </div>
