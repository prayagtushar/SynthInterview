...
export default function FinalCTA() {
  return (
    <section className="section-container bg-[#030303] border-t border-white/5 py-32 md:py-48 overflow-hidden">
      ...
      >
        <motion.div variants={fadeUpVariants} className="flex flex-col items-center text-center">
          ...
          <h2 className="section-title text-gradient !text-4xl md:!text-7xl leading-[1.1] mb-12">
            Ready to <span className="font-serif-italic">upgrade</span> <br /> your hiring process?
          </h2>
          <p className="mt-8 text-white/70 max-w-2xl text-lg md:text-xl leading-relaxed mx-auto mb-24">
            Join the new standard of technical hiring. Start using our AI-powered interview engine today.
          </p>
        </motion.div>
        ...
        >
          ...
          >
            ...
            <div className="space-y-3 mt-4">
               <h3 className="text-2xl md:text-3xl font-bold tracking-tight text-white transition-colors">Try Sandbox</h3>
               <p className="text-white/50 text-base md:text-lg font-medium leading-relaxed group-hover:text-white/70 transition-colors">Experience the autonomous dialogue as a candidate.</p>
            </div>
          ...
          >
            ...
            <div className="space-y-3 mt-4">
               <h3 className="text-2xl md:text-3xl font-bold tracking-tight text-white transition-colors">Recruiter Console</h3>
               <p className="text-white/50 text-base md:text-lg font-medium leading-relaxed group-hover:text-white/70 transition-colors">Manage sessions and analyze deep-technical scorecards.</p>
            </div>
            <div className="mt-12 flex items-center gap-2 text-[10px] font-bold uppercase tracking-[0.3em] text-white/30 group-hover:text-white/60 transition-colors">
